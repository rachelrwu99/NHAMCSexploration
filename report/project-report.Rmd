...
We proceeded to evaluate our classifier with an ROC Curve in Figure \@ref(fig:roc-plot). The area under the curve is 0.6812, making the baseline classifier stronger than 
...
knitr::include_graphics("../results/boosting_age_partial_dependence_plot")
```
...
knitr::include_graphics("../results/boosting_totdiag_partial_dependence_plot")
```
