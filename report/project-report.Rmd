...
We were able to achieve a misclassification rate of 8.5% which is a significant improvement from previous models.
...
Finally, we used boosted decision trees to predict our response variable. Figure \@ref(fig:boost-error-plot) shows the CV errors for different tree depths, helping us to 
