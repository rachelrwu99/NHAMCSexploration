...
We started our analysis using a logistic regression based on a limited subset of 50 features due to the high complexity of a logistic regression classifier with 159 variables that would be prone to overfitting.
...
For the elastic net regression, Figure \@ref(fig:elnet-CV-plot) shows the CV plot, Figure \@ref(fig:elnet-trace-plot) shows the trace plot, and Table \@ref(tab:elnet-coefficients) shows the selected features and their coefficients. 
