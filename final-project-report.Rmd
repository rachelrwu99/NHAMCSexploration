...
#Imput missing data
data_clean_delete_missing <- data_raw_ordered[!(data_raw_ordered$RESIDNCE < 0 |
...
data_clean_delete_var <- data_clean_delete_var %>%
  select(-c(CONTSUB10:CONTSUB19, CONTSUB20:CONTSUB9, 
...
#get rid of NA rows for PRESC1, PRESC2
...
#LOV replace -7, -9 and PAINSCALE replace -8, POPCT
#Do we keep PRDIAG2 & 3? check w nrow(data_clean_delete_var[data_clean_delete_var$PRDIAG2==-7, ])
