...
data_clean_delete = data_clean_combine %>% 
  select(-c(AGER, AGEDAYS, 
            ...
            BLANK3, BLANK4, CPSUM, CSTRATM, COMSTAT1:COMSTAT9,EDWT, HDDIAG1:HDDIAG5R, 
...
colnames(data_clean_delete)
sapply(data_clean_delete, typeof) #This tells us which columns are chars -> all of the RX variables!!
